...
import { COUNTRY_CONTRACT_ADDRESS, transformCharacterData } from '../../constants';
import CountryLand from '../../utils/CountryLand.json';
 ...
 */
const [mintingCharacter, ] = useState(false);
// UseEffect
useEffect(() => {
...
useEffect(() => {
  ...
  alert(`Your NFT is all done -- see it here: https://testnets.opensea.io/assets/${gameContract}/${tokenId.toNumber()}`)
    ...
    if (gameContract) {
      ...
      setCharacterNFT(characterNFT=>transformCharacterData(characterNFT));
    }
  };
